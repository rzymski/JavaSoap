    ...
    extends Service
{
    ...
    private final static QName SERVERIMPLSERVICE_QNAME = new QName("http://service.soap/", "ServerImplService");
    ...
    public Server getServerImplPort() {
        return super.getPort(new QName("http://service.soap/", "ServerImplPort"), Server.class);
    }
    ...
    public Server getServerImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.soap/", "ServerImplPort"), Server.class, features);
    }
