 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://soap/", wsdlLocation = "http://localhost:8080/JavaSoap/HelloWorldImplService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://soap/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/JavaSoap/HelloWorldImplService?WSDL");
            // url = new URL("http://localhost:8181/JavaSoap/HelloWorldImplService?WSDL");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://soap/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
