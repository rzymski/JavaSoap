...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\programowanie\java\rsi\JavaSoap\pythonClient\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\programowanie\java\rsi\JavaSoap\pythonClient\venv\Scripts\deactivate.nu'
